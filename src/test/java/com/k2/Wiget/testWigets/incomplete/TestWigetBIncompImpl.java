package com.k2.Wiget.testWigets.incomplete;
...
@WigetImplementation
public class TestWigetBIncompImpl extends ATestWiget<TypeB> implements TestWigetB{
	...
	public PrintWriter output(
		...
		out.println("Alternative Test wiget B");
